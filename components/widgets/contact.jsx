          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-slate-500 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <p className="mt-6 max-w-3xl text-base text-indigo-50">
                Find me through the below details
              </p>
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">+265 (995) 800-955</span>
                </dd>
                <dt>
                  <span className="sr-only">Phone number</span>
                </dt>
                <dd className="flex text-base text-indigo-50">
                  <PhoneIcon className="h-6 w-6 flex-shrink-0 text-indigo-200" aria-hidden="true" />
                  <span className="ml-3">+265 (889) 908-040</span>
                </dd>
                <dt>
                ...
                <dd className="flex text-base text-indigo-50">
                  ...
                  <span className="ml-3">bernardmasache@gmail.com</span>
                </dd>
              </dl>
              ...
              <form action="#" method="POST" className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div className="sm:col-span-2 sm:flex sm:justify-end">
                  <button
                    ...
                    type="submit"
                    className="mt-2 inline-flex w-full items-center justify-center rounded-md border border-transparent bg-slate-500 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                   >
                    Submit
                  </button>
                </div>
